...
community layer would just be hollow — social features with nothing to populate them. Public
...
just a preference — it's aligning the watchlist with a pattern the codebase already
